  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        <motion.div
          className="dark:bg-gray-800 bg-gray-300  rounded-2xl shadow-xl overflow-hidden border border-gray-700"
        ...
        >
          ...
          <div className="p-8 md:p-12">
            <h3 className="text-3xl font-bold dark:text-white text-black mb-6 text-center">
              Connect with Me
            </h3>
